...
const createGame = (gameDiv, timerDiv, gameOverCallback) => new Promise((resolve) => {
  ...
  const createCard = async (index, value) => {
    const div = $("div", { 
